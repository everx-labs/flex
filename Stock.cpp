...
class Stock final : public smart_interface<IStock>, public DStock {
...
public:
  ...
  // =============== Support functions ==================
  DEFAULT_SUPPORT_FUNCTIONS(IStock, replay_protection_t)
...
DEFINE_JSON_ABI(IStock, DStock, EStock);

// ----------------------------- Main entry functions ---------------------- //
DEFAULT_MAIN_ENTRY_FUNCTIONS(Stock, IStock, DStock, TIMESTAMP_DELAY)
